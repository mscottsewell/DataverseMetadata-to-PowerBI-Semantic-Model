...
namespace DataverseMetadataExtractor.Forms
{
    ...
    public class FactDimensionSelectorDialog : Form
    {
        ...
        {
            // Must have a fact table selected and at least one relationship checked
            var hasFactTable = SelectedFactTable != null;
            var hasSelection = listViewRelationships.CheckedItems.Count > 0;
            btnFinish.Enabled = hasFactTable && hasSelection;
        }
